...
export default function HomePage() {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${isDarkTheme ? "bg-[#1E4A87]" : "bg-[#D9F3FF]"}`}>
      ...
      <div className="flex items-center justify-center px-6 py-12">
        <div className="max-w-6xl mx-auto w-full">
          ...
          <div className="bg-[#E65B02] rounded-lg shadow-lg w-full mx-auto card-animation relative mb-8 transition-colors duration-300">
            <div className="px-10 py-12 text-center">
              {/* TÍTULO PRINCIPAL: Mantendo estilo do tema escuro */}
              <h1 className="text-white text-4xl font-semibold mb-6 title-animation">
                Aprenda HTML do Básico ao Avançado
              </h1>

              {/* DESCRIÇÃO: Mantendo estilo do tema escuro */}
              <p className="text-gray-200 text-xl max-w-3xl mx-auto mb-8 leading-relaxed">
              ...
              <div className="form-group-animation" style={{ animationDelay: "300ms" }}>
                <Button
                  ...
                  className="bg-programin-blue text-white py-3 px-8 rounded-md hover:bg-opacity-90 transition-colors font-medium button-animation text-lg"
                >
          ...
          <div
            className="bg-[#E65B02] rounded-lg shadow-lg w-full mx-auto card-animation relative transition-colors duration-300"
            style={{ animationDelay: "200ms" }}
          >
            <div className="px-10 py-8">
              {/* TÍTULO DA SEÇÃO: Mantendo estilo do tema escuro */}
              <h2 className="text-white text-2xl font-semibold mb-8 text-center title-animation">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="text-center form-group-animation" style={{ animationDelay: "400ms" }}>
                  ...
                  <h3 className="font-semibold text-white mb-3 text-lg">Fundação Sólida</h3>
                ...
                <div className="text-center form-group-animation" style={{ animationDelay: "500ms" }}>
                  ...
                  <h3 className="font-semibold text-white mb-3 text-lg">Carreira Promissora</h3>
                  <p className="text-gray-200 text-sm leading-relaxed">
                ...
                <div className="text-center form-group-animation" style={{ animationDelay: "600ms" }}>
                  ...
                  <h3 className="font-semibold text-white mb-3 text-lg">Projetos Reais</h3>
                  <p className="text-gray-200 text-sm leading-relaxed">
