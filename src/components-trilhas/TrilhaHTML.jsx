...
/**
 * Componente TrilhaHTML - Trilha de aprendizado para HTML
 *
 * Este componente exibe uma trilha horizontal de 10 módulos de HTML
 * representando um caminho de aprendizado que o usuário percorre.
 */
export default function TrilhaHTML() {
  ...
  // Lista de módulos da trilha de HTML
  ...
  return (
    <div className="p-6 bg-gray-900 rounded-lg shadow-lg mb-8">
      <h2 className="text-2xl font-bold mb-4 text-orange-500">Trilha de HTML</h2>
      <p className="mb-6 text-gray-300">Siga o caminho para dominar HTML:</p>
          ...
          {modulos.map((modulo, index) => {
            ...
            const circleClasses = concluido
              ...
              : modulosAnterioresConcluidos
                ? "bg-gray-800 border-orange-500 cursor-pointer"
                ...
                {index < modulos.length - 1 && (
                  <div
                    className={`h-2 absolute top-6 left-6 z-0 rounded-full ${
                      concluido ? "bg-orange-500" : "bg-gray-700"
                    }`}
                    style={{
      ...
      <div className="bg-gray-800 p-4 rounded-lg">
        {modulosConcluidos.some((status) => status === true) ? (
          <>
            <h3 className="text-lg font-medium text-orange-400 mb-2">Módulos concluídos:</h3>
