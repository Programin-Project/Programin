...
function AuthLayout({ children, title }) {
  return (
    ...
    >
      ...
      {/* Card principal */}
      <div className="bg-white rounded-lg shadow-lg w-full max-w-md mx-auto z-10 my-10 card-animation relative">
        ...
        <div className="px-10 py-8">
          {title && (
            <h1 className="text-[#1a1f36] text-2xl font-semibold text-center mb-8 title-animation">
              {title}
            </h1>
          )}
          {children}
